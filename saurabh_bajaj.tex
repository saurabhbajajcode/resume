...
\begin{body}
    \vspace{14pt}
    \textbf{Senior Software Engineer - iOS}, \emph{Amura Marketing Technologies, Pune} \hfill \emph{Sept 2018 - Present}\\
    \begin{itemize} \itemsep -0pt  % reduce space between items
        \item Enriching the product application with new features and enhancements.
    \end{itemize}
    \begin{itemize} \itemsep -0pt  % reduce space between items
        \item Handling a resource and ensuring timely development and delivery of application with minimal bugs.
    \end{itemize}
    \begin{itemize} \itemsep -0pt  % reduce space between items
        \item Swiftlint, Fastlane, Firebase, Charts.
    \end{itemize}
    \vspace*{-4pt}
